<?php $__env->startSection('title', 'Steam Stopper'); ?>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5 style="display: inline">Steam Stopper  </h5>
                        <a href="<?php echo e(url('admin/steam_stopper/add')); ?>"
                        ...
                        <div class="table-responsive">
                            <div id="example-style-4_wrapper" class="dataTables_wrapper">
                                ...
                                <table class="hover dataTable" id="example-style-4" role="grid"
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $steam_stoppers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr role="row" class="odd">
                                                ...
                                                <td><a class="btn btn-success theme"
                                                        href="<?php echo e(url('admin/steam_stopper/edit/' . \Crypt::encrypt($item->id))); ?>"
                                                        ...
                                                        href="<?php echo e(url('admin/steam_stopper/delete/' . \Crypt::encrypt($item->id))); ?>"
                                                        type="button" data-original-title="btn btn-danger "
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/atlantis/resources/views/admin/pages/steam_stopper/list.blade.php ENDPATH**/ ?>