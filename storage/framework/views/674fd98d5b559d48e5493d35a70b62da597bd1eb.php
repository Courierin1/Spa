<?php $__env->startSection('title', 'Add Steam Stopper'); ?>
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-header">
                                <h5>Add Steam Stopper</h5>
                            </div>
                            <div class="card-body">
                                <form action="<?php echo e(url('admin/steam_stopper/add_post')); ?>" class="theme-form mega-form" method="POST"
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/atlantis/resources/views/admin/pages/steam_stopper/add.blade.php ENDPATH**/ ?>