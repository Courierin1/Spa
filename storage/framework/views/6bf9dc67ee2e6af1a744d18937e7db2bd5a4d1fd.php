<?php $__env->startSection('title', 'Add Cover Lift'); ?>
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-header">
                                <h5>Add Cover Lift</h5>
                            </div>
                            <div class="card-body">
                                <form action="<?php echo e(url('admin/cover_lift/add_post')); ?>" class="theme-form mega-form" method="POST"
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" id="name" name="name" value=""
                                                    type="text" placeholder="Enter Cover Lift Name" data-bs-original-title=""
                                                    title="">
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/atlantis/resources/views/admin/pages/cover_lift/add.blade.php ENDPATH**/ ?>