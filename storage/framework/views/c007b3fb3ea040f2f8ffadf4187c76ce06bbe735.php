            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="<?php echo e(url('admin/history/add')); ?>"
                                        ...
                                        <?php $__currentLoopData = $histories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr role="row" class="odd">
                                                ...
                                                <td><a class="btn btn-success theme"
                                                        href="<?php echo e(url('admin/history/edit/' . \Crypt::encrypt($item->id))); ?>"
                                                        ...
                                                        href="<?php echo e(url('admin/history/delete/' . \Crypt::encrypt($item->id))); ?>"
                                                        type="button" data-original-title="btn btn-danger "
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/brewery/resources/views/admin/pages/history/list.blade.php ENDPATH**/ ?>