<?php $__env->startSection('title', 'Add Breadcrumb'); ?>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="<?php echo e(url('admin/breadcrumb/add_post')); ?>" class="theme-form mega-form" method="POST"
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/brewery/resources/views/admin/pages/breadcrumb/add.blade.php ENDPATH**/ ?>