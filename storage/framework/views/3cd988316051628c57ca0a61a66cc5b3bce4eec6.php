...
?>
<?php $shape = "Circle"?>
<?php $page_title = "Circle";?>
<?php $img_shape = "Cir.png";?>
                ...
                <div class="col-md-8 my-5" id="inputs">
                    <form action="">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-2">
                                <div class="mb-3 row align-items-center">
                                    <label for="staticEmail" class="col-sm-3 col-form-label mb-0 fs-15">A (Radius):</label>
                                    <div class="col-sm-9">
                                      <input type="number" class="form-control" id="staticEmail" >
                                    </div>
...
<?php echo $__env->make('home.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/atlantis/resources/views/home/pages/circle.blade.php ENDPATH**/ ?>