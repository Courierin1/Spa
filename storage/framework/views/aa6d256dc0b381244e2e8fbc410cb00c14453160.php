...
<?php $__env->startSection('category-items'); ?>
    <li class="category-item">Categories</li>
    <li class="category-item active"> Edit Category</li>
<?php $__env->stopSection(); ?>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="<?php echo e(url('admin/map/edit_post')); ?>" class="theme-form mega-form" method="POST"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" id="name" disabled name="name" value="<?php echo e($category->name); ?>"
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/brewery/resources/views/admin/pages/map/edit.blade.php ENDPATH**/ ?>