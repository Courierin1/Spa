                                                ...
                                                <td class="sorting_1">
                                                    <div class="btn-group">
                                                        <button type="button" class="btn btn-primary dropdown-toggle" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                            <?php echo e($item->gear_status == 1? 'Enabled' : 'Disabled'); ?>

                                                        </button>
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item" href="<?php echo e(url('admin/gear/' . \Crypt::encrypt($item->id) . '/1')); ?>">Enable</a>
                                                            <a class="dropdown-item" href="<?php echo e(url('admin/gear/' . \Crypt::encrypt($item->id) . '/0')); ?>">Disable</a>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/brewery/resources/views/admin/pages/gear/list.blade.php ENDPATH**/ ?>