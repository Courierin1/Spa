            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="<?php echo e(url('admin/review/add')); ?>"
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $reviews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr role="row" class="odd">
                                                <td class="sorting_1"><img src="<?php echo e(asset($item->img1)); ?>" height="50"  alt=""></td>
                                                <td class="sorting_1"><img src="<?php echo e(asset($item->img2)); ?>" height="50"  alt=""></td>
                                                <td class="sorting_1"> <a href="<?php echo e($item->link); ?>" target="_blank" rel="noopener noreferrer"><?php echo e($item->link); ?></a></td>
                                                ...
                                                <td><a class="btn btn-success theme"
                                                        href="<?php echo e(url('admin/review/edit/' . \Crypt::encrypt($item->id))); ?>"
                                                        ...
                                                        href="<?php echo e(url('admin/review/delete/' . \Crypt::encrypt($item->id))); ?>"
                                                        type="button" data-original-title="btn btn-danger "
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/brewery/resources/views/admin/pages/review/list.blade.php ENDPATH**/ ?>