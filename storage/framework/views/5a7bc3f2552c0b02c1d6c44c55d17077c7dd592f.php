...
?>
<?php $shape = "Rectangle Rounded Corners"?>
<?php $page_title = "Rectangle with Rounded Corners";?>
<?php $img_shape = "RRC.png";?>
 ...
 $( document ).ready(function() {
    $('#fold_direction').change(function(){
        ...
        if (value == 'Cut B: in Half') {
            img.src = "<?php echo e(asset('home/images/changes_shapes/Hard3-RRC2.png')); ?>"
        }
        else{
...
<?php echo $__env->make('home.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/atlantis/resources/views/home/pages/rectangle_rounded_corners.blade.php ENDPATH**/ ?>