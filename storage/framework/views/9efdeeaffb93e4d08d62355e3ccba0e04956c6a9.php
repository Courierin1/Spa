<?php $__env->startSection('title', 'Edit Floor Plan'); ?>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="<?php echo e(url('admin/floor_plan/edit_post')); ?>" class="theme-form mega-form" method="POST"
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" id="name" name="name" disabled value="<?php echo e($category->name); ?>"
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/brewery/resources/views/admin/pages/floor_plan/edit.blade.php ENDPATH**/ ?>