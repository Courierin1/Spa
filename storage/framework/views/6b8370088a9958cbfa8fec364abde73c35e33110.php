<?php $__env->startSection('title', 'Add Vapor Barrier'); ?>
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-header">
                                <h5>Add Vapor Barrier</h5>
                            </div>
                            <div class="card-body">
                                <form action="<?php echo e(url('admin/vapor_barrier/add_post')); ?>" class="theme-form mega-form" method="POST"
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/atlantis/resources/views/admin/pages/vapor_barrier/add.blade.php ENDPATH**/ ?>