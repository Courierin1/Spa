<?php $__env->startSection('title', 'Other Service'); ?>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="<?php echo e(url('admin/other_service/add')); ?>"
                        ...
                        <div class="table-responsive">
                            <div id="example-style-4_wrapper" class="dataTables_wrapper">
                                ...
                                <table class="hover dataTable" id="example-style-4" role="grid"
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $other_services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr role="row" class="odd">
                                                <td class="sorting_1"><a href="<?php echo e($item->link); ?>"><?php echo e($item->heading); ?></a></td>
                                                <td class="sorting_1"><?php echo e(mb_strimwidth($item->description, 0, 20, "...")); ?></td>
                                                <td class="sorting_1"><?php echo e($item->status ==1 ? "Enabled": "Disabled"); ?></td>
                                                <td><?php echo e($item->created_at->isoFormat('D-M-Y')); ?></td>
                                                <td><a class="btn btn-success theme"
                                                        href="<?php echo e(url('admin/other_service/edit/' . \Crypt::encrypt($item->id))); ?>"
                                                        ...
                                                        href="<?php echo e(url('admin/other_service/delete/' . \Crypt::encrypt($item->id))); ?>"
                                                        type="button" data-original-title="btn btn-danger "
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/brewery/resources/views/admin/pages/other_service/list.blade.php ENDPATH**/ ?>