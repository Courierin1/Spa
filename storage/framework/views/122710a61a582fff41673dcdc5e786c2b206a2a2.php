...
?>
<?php $shape = "Two Cut Corner"?>
<?php $page_title = "Two Cut Corner";?>
<?php $img_shape = "Hard3-TCC.png";?>
                ...
                <div class="col-md-8 my-5" id="inputs">
                    <form action="">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-2">
                                <div class="mb-3 row align-items-center">
                                    <label for="staticEmail" class="col-sm-3 col-form-label mb-0 fs-15">E (Inches):</label>
                                    <div class="col-sm-9">
                                      <input type="number" class="form-control" id="staticEmail" >
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6 mb-2">
                                <div class="mb-3 row align-items-center">
                                    <label for="staticEmail" class="col-sm-3 col-form-label mb-0 fs-15">F (Radius):</label>
                                    <div class="col-sm-9">
                                      <input type="number" class="form-control" id="staticEmail" >
                                    </div>
                                    <div class="col-sm-3"></div>
                                    <div class="col-sm-9">
                                        <a href="javascript:void(0)" class="text-sky fs-13" data-bs-toggle="modal" data-bs-target="#exampleModal">How to find a Radius?</a>
                                        <?php echo $__env->make("home.includes.modal", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>                                    </div>
                                </div>
                            </div>
...
<?php echo $__env->make('home.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/atlantis/resources/views/home/pages/two_cut_corner.blade.php ENDPATH**/ ?>