<?php $__env->startSection('title', 'Studio Tour'); ?>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="<?php echo e(url('admin/studio_tour/add')); ?>"
                        ...
                        <div class="table-responsive">
                            <div id="example-style-4_wrapper" class="dataTables_wrapper">
                                ...
                                <table class="hover dataTable" id="example-style-4" role="grid"
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $studio_tours; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr role="row" class="odd">
                                                <td class="sorting_1"><?php echo e($item->heading); ?></td>
                                                ...
                                                <td><a class="btn btn-success theme"
                                                        href="<?php echo e(url('admin/studio_tour/edit/' . \Crypt::encrypt($item->id))); ?>"
                                                        ...
                                                        href="<?php echo e(url('admin/studio_tour/delete/' . \Crypt::encrypt($item->id))); ?>"
                                                        type="button" data-original-title="btn btn-danger "
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/brewery/resources/views/admin/pages/studio_tour/list.blade.php ENDPATH**/ ?>