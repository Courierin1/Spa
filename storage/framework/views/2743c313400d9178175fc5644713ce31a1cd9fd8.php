<?php $__env->startSection('title', 'Studio Booking'); ?>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="<?php echo e(url('admin/plan/add')); ?>"
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $plans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr role="row" class="odd">
                                                ...
                                                <td class="sorting_1"><?php echo e($item->per_hour); ?></td>
                                                <td class="sorting_1"><?php echo e($item->half_day); ?></td>
                                                <td class="sorting_1"><?php echo e($item->full_day); ?></td>
                                                ...
                                                <td><a class="btn btn-success theme"
                                                        href="<?php echo e(url('admin/plan/edit/' . \Crypt::encrypt($item->id))); ?>"
                                                        ...
                                                        href="<?php echo e(url('admin/plan/delete/' . \Crypt::encrypt($item->id))); ?>"
                                                        type="button" data-original-title="btn btn-danger "
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/brewery/resources/views/admin/pages/plan/list.blade.php ENDPATH**/ ?>