<?php $__env->startSection('title', 'Add Cover Cap'); ?>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="<?php echo e(url('admin/cover_cap/add_post')); ?>" class="theme-form mega-form" method="POST"
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/atlantis/resources/views/admin/pages/cover_cap/add.blade.php ENDPATH**/ ?>