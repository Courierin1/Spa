            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5 style="display: inline">Plan </h5>
                                ...
                                <table class="hover dataTable" id="example-style-4" role="grid"
                                    ...
                                    <thead>
                                        ...
                                        <tr role="row">
                                            ...
                                            <th rowspan="1" colspan="1">Description 1</th>
                                            <th rowspan="1" colspan="1">Description 2</th>
                                            <th rowspan="1" colspan="1">Field Status</th>
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $plans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr role="row" class="odd">
                                                ...
                                                <td class="sorting_1"><?php echo e(mb_strimwidth($item->description_1, 0, 20, "...")); ?></td>
                                                <td class="sorting_1"><?php echo e(mb_strimwidth($item->description_2, 0, 20, "...")); ?></td>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/atlantis/resources/views/admin/pages/plan/list.blade.php ENDPATH**/ ?>