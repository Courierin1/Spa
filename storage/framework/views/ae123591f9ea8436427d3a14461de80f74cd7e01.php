<?php $__env->startSection('title', 'Add Foam Density'); ?>
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-header">
                                <h5>Add Foam Density</h5>
                            </div>
                            <div class="card-body">
                                <form action="<?php echo e(url('admin/foam_density/add_post')); ?>" class="theme-form mega-form" method="POST"
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/atlantis/resources/views/admin/pages/foam_density/add.blade.php ENDPATH**/ ?>