            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5 style="display: inline">Map & Location </h5>
                    </div>
                    <div class="card-body">
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr role="row" class="odd">
                                                ...
                                                <td class="sorting_1"><?php echo e($item->location); ?></td>
                                                <td class="sorting_1"><?php echo e($item->logitute); ?></td>
                                                <td class="sorting_1"><?php echo e($item->latitute); ?></td>
                                                <td>
                                                    <a class="btn btn-success theme"
                                                        href="<?php echo e(url('admin/map/edit/' . \Crypt::encrypt($item->id))); ?>"
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/brewery/resources/views/admin/pages/map/list.blade.php ENDPATH**/ ?>