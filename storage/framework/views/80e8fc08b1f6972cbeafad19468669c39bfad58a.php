                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr role="row" class="odd">
                                                ...
                                                <td class="sorting_1"><img src="<?php echo e(asset($item->floor_plan)); ?>" height="50"  alt=""></td>
                                                <td class="sorting_1"><?php echo e($item->name); ?></td>
                                                <td class="sorting_1"><?php echo e(mb_strimwidth($item->address, 0, 20, "...")); ?></td>
                                                ...
                                                <td><a class="btn btn-success theme"
                                                        href="<?php echo e(url('admin/category/edit/' . \Crypt::encrypt($item->id))); ?>"
                                                        ...
                                                        href="<?php echo e(url('admin/category/delete/' . \Crypt::encrypt($item->id))); ?>"
                                                        type="button" data-original-title="btn btn-danger "
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/brewery/resources/views/admin/pages/category/list.blade.php ENDPATH**/ ?>