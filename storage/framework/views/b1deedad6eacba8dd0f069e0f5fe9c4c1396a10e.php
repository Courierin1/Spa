...
?>
<?php $shape = "Square Rounded Corners"?>
<?php $page_title = "Square with Rounded Corners";?>
<?php $img_shape = "SRC.png";?>
        ...
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-md-4 position-relative" id="images">
                    ...
                    <!-- <h2 class="text-uppercase "><?php echo $shape;?></h2> -->
                </div>
...
<?php echo $__env->make('home.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/atlantis/resources/views/home/pages/square_rounded_corners.blade.php ENDPATH**/ ?>